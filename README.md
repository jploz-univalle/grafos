...
Este proyecto esta diseñado para virtualizar informacion de un grafo dada en un formato especifico y evaluar algunas caracteristicas del mismo, por ejemplo si es un multigrafo o si es completo.
